...
<div class="container">
    <h2 class="text-center text-black-50">Update Admission</h2>
    <?php
    ...
    if ($result->num_rows > 0)
    {
        ...
        {
            ?>
    <form action="update_adm.php" method="post" class="shadow">
   <div class="form-group">
       <table class="table table-striped table-secondary">
           <tr>
               <td align="center"><label for=""><b>Admission Number</b></label></td>
               <td><input type="number" name="Amdmno"  class="form-control"  value="<?php echo $row['admission_no']; ?>"></td>
           </tr>
           <tr>
               <td align="center"><label for=""><b>Admission Date</b></label></td>
