...
<div class="container">
            ...
            <h2 class="text-center text-black-50">Inquiry</h2>
            <hr>
            <?php
            ...
            if ($result->num_rows>0){
                while ($row=$result->fetch_assoc()){
                    ...
                    ?>
                    <form action="update_inquiry.php" method="post" class="shadow forms">
                        <div class="form-group">
                            <table class="table table-striped table-secondary">
                                ...
                                <tr>
                                    <td align="center"><label for=""><b>Comments</b></label></td>
