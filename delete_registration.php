...
if ($conn->query($sql) == TRUE){
    ...
    print "<a href='search_registerD.php' class='btn btn-info'>New Delete</a>";
    print"<br>";
    print"<br>";
    print "<a href='register.php' class='btn btn-secondary'>New Registration</a>";

}
else{
    print "<p class='text-danger'>Registration update Not Successful</p>";
    print "<a href='search_registerD.php' class='btn btn-danger'>Try again</a>";
}
mysqli_close($conn);
