...
$amount=mysqli_real_escape_string($conn,$_POST['AmounttoPay']);

$sql="INSERT INTO billing (billing_date,first_name,middle_name,last_name,course,amount_to_pay) VALUES ('$billDate','$Fname','$Mname','$Lname','$course_title','$amount')";
if ($conn->query($sql)== TRUE ){
   print "<p><b>Invoice Posted Successful!</b></p>";
    print "<a href='billing.php' class='btn btn-info'>New Billing</a>";


}
else{
    print "<p class='text-danger'><b>Invoice Not Posted Successful!</b></p>";
