...
$sql="DELETE FROM receipt  WHERE receipt_no='$ReceiptID'";
if ($conn->query($sql) == TRUE){
    print "<p class='text-danger'><b>Receipt Delete  Successful!</b></p>";
    print "<a href='recipts_Delete.php' class='btn btn-danger'>New Delete</a>";
    echo "<br>";
    echo "<br>";
    echo "<a href='receipts.php' class='btn btn-secondary'>New Receipt</a>";

}
else{
    print "<p class='text-danger'><b>Receipt delete Not Successful!</b></p>";
